...
type HealthCheckResponse struct {
	...
	AppVersionRef string `protobuf:"bytes,2,opt,name=app_version_ref,json=appVersionRef,proto3" json:"app_version_ref,omitempty"`
}
...
func (x *HealthCheckResponse) GetAppId() string {
	if x != nil {
		return x.AppId
	}
	return ""
...
func (x *HealthCheckResponse) GetAppVersionRef() string {
	if x != nil {
...
var file_health_check_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6e, 0x6f, 0x77, 0x69, 0x73, 0x22, 0x14, 0x0a, 0x12, 0x48,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x22, 0x54, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x26, 0x0a, 0x0f, 0x61, 0x70, 0x70, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x72,
	0x65, 0x66, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x61, 0x70, 0x70, 0x56, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x66, 0x42, 0x1a, 0x5a, 0x18, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_health_check_proto_goTypes = []interface{}{
	...
	(*HealthCheckResponse)(nil), // 1: nowis.HealthCheckResponse
}
